...
const svgClass = "h-5 w-5 text-gray-400";
const toggleSvgClass = "h-6 w-6 text-gray-400";
...
export const KeyIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg className={className || svgClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
    </svg>
);

export const UserIcon: React.FC<{className?: string, inWrapper?: boolean}> = ({className, inWrapper = true}) => {
    const icon = (
        <svg className={className || svgClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    return inWrapper ? <IconWrapper>{icon}</IconWrapper> : icon;
};
...
export const UnpinIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg className={className || svgClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14 M3 3l18 18" />
    </svg>
);
...
export const SearchIconSolid: React.FC<{className?: string}> = ({ className }) => (
...
export const EyeIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg className={className || toggleSvgClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const EyeOffIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg className={className || toggleSvgClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a10.05 10.05 0 015.68-5.408M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
...
export const WarningIcon: React.FC = () => (
    <div className="flex-shrink-0 mr-3">
        <svg className="h-5 w-5 text-amber-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.21 3.03-1.742 3.03H4.42c-1.532 0-2.492-1.696-1.742-3.03l5.58-9.92zM10 13a1 1 0 100-2 1 1 0 000 2zm-1-8a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clipRule="evenodd" />
        </svg>
    </div>
);

export const MailIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg className={className || svgClass} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const FundsIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg className={className || svgClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const UserCircleIcon: React.FC<{className?: string, onClick?: (e: React.MouseEvent) => void}> = ({ className, onClick }) => (
    <svg className={className || svgClass} fill="none" viewBox="0 0 24 24" stroke="currentColor" onClick={onClick}>
...
export const PencilIcon: React.FC<{className?: string, inWrapper?: boolean}> = ({ className, inWrapper }) => {
    const icon = <svg className={className || svgClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const PaletteIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg className={className || svgClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.357 1.657 1.357" />
    </svg>
);
...
export const HeartIconSolid: React.FC<{className?: string}> = ({ className }) => (
    <svg className={className || svgClass} viewBox="0 0 20 20" fill="currentColor">
...
export const DoubleCheckIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg className={className || svgClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l-4 4" />
    </svg>
);
